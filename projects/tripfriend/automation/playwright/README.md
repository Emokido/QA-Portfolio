...
현재 상태는 수정 후 정상 회귀 `5/5 Pass`, 등록 결함 재현 `3/3 재현`이다. 정상 회귀에서는 001·002·003-A·003-B·004가 모두 Pass했다. TF-E2E-003-B는 기준 제품에서 TF-BUG-015를 발견했고 별도 QA 환경 교정 후 단일·전체 회귀에서 Pass했다. 등록 결함 재현에서는 TF-BUG-010과 TF-BUG-014의 1자·101자 경계가 모두 예상대로 검출됐다.
