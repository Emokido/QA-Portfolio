...
- **첫 원인 가설이 맞는가:** [수정 폼 초기값 문제](projects/tripfriend/defects/TF-BUG-015-review-edit-form-initial-values-empty.md)의 Next.js 동적 경로 처리 가설을 반증하고 QA 사본 교정 후 단일 재검증·전체 회귀를 확인했습니다.
